...
internal sealed class GameCodeService : IDisposable
{
        ...
        IProcessRunner? processRunner = null)
    {
        ...
        var sourceRoot = Path.GetDirectoryName(project.GameProjectPath)!;
        _sourceWatcher = new FileSystemWatcher(sourceRoot)
        {
        ...
        _sourceWatcher.Deleted += OnSourceChanged;
        _sourceWatcher.Renamed += OnSourceRenamed;
        _sourceWatcher.Error += OnWatcherError;
