...
public class UINineSlice : UIElement
{
    ...
    public override void OnDrawUI()
    {
        ...
        var topRightDest    = new Rectangle(dr.Right - topRightSource.Width, dr.Top, topRightSource.Width, topRightSource.Height);
        
        var middleLeftDest  = new Rectangle(dr.Left, dr.Top + topLeftSource.Height, topLeftSource.Width, middleHeight);
        var middleDest      = new Rectangle(dr.Left + topLeftSource.Width, dr.Top + topLeftSource.Height, middleWidth, middleHeight);
        var middleRightDest = new Rectangle(dr.Right - topRightSource.Width, dr.Top + topLeftSource.Height, topRightSource.Width, middleHeight);
        
        var bottomLeftDest   = new Rectangle(dr.Left, dr.Bottom - bottomLeftSource.Height, bottomLeftSource.Width, bottomLeftSource.Height);
        ...
        var bottomRightDest  = new Rectangle(dr.Right - bottomRightSource.Width, dr.Bottom - bottomMiddleSource.Height, bottomRightSource.Width, bottomMiddleSource.Height);
