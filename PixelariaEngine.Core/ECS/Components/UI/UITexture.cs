...
public class UITexture : UIElement
{
    ...
    public static UITexture Create(Canvas canvas, string texturePath, PivotType pivotType = PivotType.Center, Vector2? pivot = null)
    {
    ...
    private Rectangle GetDestinationRect()
    {
        ...
        var size = CanScale ? Canvas.ConvertToScreenSize(new Vector2(Width, Height)) 
