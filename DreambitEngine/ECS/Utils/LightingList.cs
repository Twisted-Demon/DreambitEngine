...
public class LightingList
{
    ...
    public List<Light2D> GetAllLights() => _all;
    public List<Light2D> GetAllEnabledLights() => GetAllLights().Where(IsEnabled).ToList();

    private static bool IsEnabled(Light2D light) => light.Enabled && light.Entity.Enabled;
