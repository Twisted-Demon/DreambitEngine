...
{
    public static LDtkFile FromJson(string json, string filePath)
    {
    ...
    public static LDtkWorld LoadWorld(this LDtkFile file, Guid iid)
    {
    ...
    public static LDtkLevel LoadLevel(this LDtkWorld world, Guid iid)
    {
        foreach (var level in world.Levels)
        {
            if (level.Iid != iid)
            ...
            return world.LoadLevel(level);
        }

        throw new Exception($"No level with iid: {iid} found in this world");
    }

    public static LDtkLevel LoadLevel(this LDtkWorld world, string identifier)
    {
        foreach (var level in world.Levels)
        {
    ...
    public static LDtkLevel LoadLevel(this LDtkWorld world, LDtkLevel rawLevel)
    {
