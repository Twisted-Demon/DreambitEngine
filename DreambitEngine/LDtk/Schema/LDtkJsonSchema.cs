...
// Generated from the official LDtk 1.5.3 minimal JSON schema.
// See LICENSE.md in this directory for attribution.
...
public partial class LDtkFile
{
    ...
    public LdtkColor BgColor { get; set; }
...
public partial class AutoLayerRuleGroup
{
    ...
    public LdtkColor? Color { get; set; }
...
public partial class EntityInstance
{
    ...
    public LdtkPoint _Grid { get; set; }
    ...
    public LdtkVector2 _Pivot { get; set; }
    ...
    public LdtkColor _SmartColor { get; set; }
...
public partial class LDtkLevel
{
    ...
    public LdtkColor _BgColor { get; set; }
...
public partial class LevelBackgroundPosition
{
    ...
    public LdtkVector2 Scale { get; set; }
    ...
    public LdtkPoint TopLeftPx { get; set; }
}
