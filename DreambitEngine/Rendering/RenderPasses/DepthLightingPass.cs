...
public class DepthLightingPass : RenderPass
{
    ...
    private DepthPass DepthPass { get; set; }
    private RenderTarget2D DepthRt => DepthPass.DepthRt;
    ...
    public override void Initialize()
    {
        ...
        DepthPass = RenderPipeline.GetRenderPass<DepthPass>();
        ArgumentNullException.ThrowIfNull(DepthPass);

        LightingFx = Resources.LoadAsset<DreambitEffect>("Effects/DepthLighting2D");
    ...
    private void RenderLighting()
    {
        ...
        LightingFx.Effect.Parameters["DepthTexture"]?.SetValue(DepthRt);
